...
export default function Story() {
  ...
  return (
    <div className="min-h-screen bg-[#FBFBFC] text-slate-900 pb-32 relative">
      ...
      {toast.show && (
        <div
          className={`fixed bottom-24 md:bottom-10 left-1/2 -translate-x-1/2 z-200lex items-center gap-3 px-6 py-4 rounded-2xl shadow-2xl border backdrop-blur-md animate-in fade-in slide-in-from-bottom-4 duration-300 ${
            toast.type === "error"
