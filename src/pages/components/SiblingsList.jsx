          ...
          return (
            ...
            >
              ...
              <button
                ...
                className="flex flex-col items-center min-w-[120px] md:w-28 p-3 bg-white rounded-2xl border border-slate-100 shadow-sm transition-all md:hover:border-indigo-300 md:hover:shadow-md active:scale-95 group"
              >
                {/* Зураг */}
                <div
