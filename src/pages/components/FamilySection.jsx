          ...
          return (
            ...
            >
              <button
                ...
                className="flex flex-col items-center min-w-[120px] md:w-28 p-3 bg-white rounded-2xl border border-slate-100 shadow-sm transition-all md:hover:border-emerald-300 md:hover:shadow-md active:scale-95 group"
              >
                <div
                ...
                <div className="text-center w-full">
                  <h3 className="text-[10px] font-bold text-slate-800 truncate leading-tight md:group-hover:text-emerald-600">
                    {person.name}
                  </h3>
